  ...
  return <div className="flex flex-col items-center gap-3 max-w-lg mx-auto">
      ...
      <form onSubmit={handleSubmit} className="flex w-full max-w-md mt-2">
        <div className="relative flex w-full">
          ...
          <input type="email" placeholder="Seu e-mail" value={email} onChange={e => setEmail(e.target.value)} required className="flex h-11 w-full rounded-l-md bg-[#1A0942] pl-10 pr-3 text-sm text-white placeholder:text-white/70 focus:outline-none" />
          <Button type="submit" className="h-11 rounded-l-none rounded-r-md bg-grou-cyan hover:bg-grou-cyan/90 text-grou-dark font-medium">
